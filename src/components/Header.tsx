  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 bg-[#3A7817]/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <div className="hidden xl:flex items-center space-x-3">
              <a href="https://www.instagram.com/heritagefarms.ca" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[#EAFDE7]/80 hover:text-[#EDDD5E] transition-colors">
              ...
              <a href="https://www.youtube.com/@HeritageFields" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-[#EAFDE7]/80 hover:text-[#EDDD5E] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-[#EAFDE7]/80 hover:text-[#EDDD5E] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-[#EAFDE7]/80 hover:text-[#EDDD5E] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                </svg>
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-[#EAFDE7]/80 hover:text-[#EDDD5E] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-[#EAFDE7]/80 hover:text-[#EDDD5E] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button 
              ...
              className="relative bg-[#EAFDE7] text-[#00312D] font-gilroy font-semibold px-4 py-3 rounded-full hover:bg-opacity-90 transition-all duration-300 mr-2"
            ...
            >
              ...
              {wishlistItems.length > 0 && (
                <span className="absolute -top-2 -right-2 bg-[#EDDD5E] text-[#00312D] text-sm font-gilroy-extrabold font-bold rounded-full w-6 h-6 flex items-center justify-center">
            ...
            <button 
              ...
              className="relative bg-[#EAFDE7] text-[#00312D] font-gilroy font-semibold px-6 py-3 rounded-full hover:bg-opacity-90 transition-all duration-300"
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden flex items-center p-2 text-[#EAFDE7] hover:text-[#EDDD5E] transition-colors"
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden ${isMobileMenuOpen ? 'block' : 'hidden'} bg-[#3A7817]/60 backdrop-blur-md rounded-lg mt-2 shadow-lg border border-white/20`}>
          <div className="px-4 py-6 space-y-4">
            <Link 
              href="/" 
              className="block text-[#EAFDE7] hover:text-[#EDDD5E] font-gilroy font-semibold text-base uppercase tracking-wider transition-colors"
            ...
            <div className="pt-4 border-t border-gray-600">
              ...
              <Link href="/products" className="block w-full bg-[#EAFDE7] text-[#00312D] font-gilroy font-semibold px-6 py-3 rounded-full hover:bg-opacity-90 transition-all duration-300 text-center">
                Shop now
              </Link>
            </div>
