...
export default function Features() {
  return (
    <section className="wrapper bg-[rgba(246,247,249,1)]">
      <div className="container py-14 xl:!py-[4.5rem] lg:!py-[4.5rem] md:!py-[4.5rem]">
        <div className="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-40px]">
            ...
            <div className="flex flex-row">
              <div>
                <svg
                  ...
                  data-inject-url="https://sandbox-tailwind-template.netlify.app/assets/img/icons/solid/shipment.svg"
                  className="svg-inject icon-svg !w-[2.2rem] !h-[2.2rem] solid-mono text-[#343f52] text-navy !mr-4"
                >
                  <path
              ...
              <div>
                ...
                <p className="!mb-0">
                  Free standard shipping on all orders over $50. Fresh heritage greens delivered to your doorstep.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-row">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 256 256"
                  data-inject-url="https://sandbox-tailwind-template.netlify.app/assets/img/icons/solid/push-cart.svg"
                  className="svg-inject icon-svg !w-[2.2rem] !h-[2.2rem] solid-mono text-[#343f52] text-navy !mr-4"
                >
                  <path
                    className="fill-secondary"
              ...
              <div>
                <h4 className="!mb-1">Fresh Guarantee</h4>
                <p className="!mb-0">
                  All our heritage greens are harvested fresh and guaranteed to arrive in perfect condition.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="md:w-6/12 lg:w-4/12 xl:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[40px] xl:!px-[35px] lg:!px-[20px]">
            <div className="flex flex-row">
              ...
              <div>
                <h4 className="!mb-1">Sustainable Farming</h4>
                <p className="!mb-0">
                  All our heritage crops are grown using sustainable greenhouse practices with 75% less water usage.
                </p>
              </div>
            </div>
          </div>
