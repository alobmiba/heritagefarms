      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 mb-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl p-10 text-center shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="text-4xl md:text-5xl font-gilroy font-bold text-[#EDDD5E] mb-2" data-count="75">
              {counts.water}%
            </div>
          ...
          <div className="bg-white rounded-2xl p-10 text-center shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="text-4xl md:text-5xl font-gilroy font-bold text-[#EDDD5E] mb-2" data-count="50">
              {counts.carbon}%
            </div>
            <h3 className="text-xl font-gilroy font-semibold text-[#404A3D] mb-2">
          ...
          <div className="bg-white rounded-2xl p-10 text-center shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="text-4xl md:text-5xl font-gilroy font-bold text-[#EDDD5E] mb-2" data-count="90">
              {counts.yield}%
            </div>
            <h3 className="text-xl font-gilroy font-semibold text-[#404A3D] mb-2">
              Year-Round Yield
          ...
          <div className="bg-white rounded-2xl p-10 text-center shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="text-4xl md:text-5xl font-gilroy font-bold text-[#EDDD5E] mb-2" data-count="100">
              {counts.waste}%
            </div>
            <h3 className="text-xl font-gilroy font-semibold text-[#404A3D] mb-2">
              Waste Diverted
        ...
        <div className="text-center mt-12">
          <a href="/sustainability-report" className="bg-[#EDDD5E] text-[#404A3D] font-gilroy font-semibold px-8 py-4 rounded-full hover:bg-opacity-90 transition-all duration-300 text-base inline-flex items-center space-x-3">
