  ...
  return (
    <section className="relative py-20 md:py-32 bg-white overflow-hidden">
      ...
      <div className="absolute right-0 top-0 w-1/3 h-full opacity-5">
        <div className="w-full h-full bg-gradient-to-br from-[#5B8C51] to-[#3A7817] rounded-l-full"></div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-[#5B8C51] to-[#3A7817] rounded-full flex items-center justify-center group-hover:shadow-lg transition-all duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              </div>
              <h5 className="text-xl font-gilroy font-bold text-[#404A3D] mb-3">Location</h5>
